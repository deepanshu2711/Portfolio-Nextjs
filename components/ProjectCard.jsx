...
const ProjectCard = ({imgUrl,title,description,githubLink}) => {
    return ( 
        ...
        <div className="">
        <div className="h-52 md:h-60 rounded-t-xl relative hover:opacity-50 group  " style={{backgroundImage: `url(${imgUrl})` ,backgroundSize:"contain" ,backgroundRepeat:"no-repeat"}} >
